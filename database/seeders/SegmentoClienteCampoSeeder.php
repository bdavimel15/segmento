...
class SegmentoClienteCampoSeeder extends Seeder
{
    public function run(): void
    {
        $campos = [
            ...
            ['chave'=>'idade','label'=>'Idade','descricao'=>'Idade calculada pela data de nascimento.','categoria'=>'cliente','tipo_valor'=>'number','expressao_sql'=>null,'operadores_json'=>['equals','not_equals','greater_than','greater_or_equal','less_than','less_or_equal','between'],'ordem'=>7],
            ...
            ['chave'=>'newsletter','label'=>'Newsletter','descricao'=>'Indica se o cliente aceita receber comunicações.','categoria'=>'cliente','tipo_valor'=>'select','opcoes'=>['SIM','NÃO'],'expressao_sql'=>"CASE WHEN c.cli_newsletter IN ('S','SIM','Sim','sim','1') THEN 'SIM' ELSE 'NÃO' END",'operadores_json'=>['is_true','is_false','equals','not_equals'],'ordem'=>12],
            ...
            ['chave'=>'carrinho_abandonado','label'=>'Carrinho abandonado','descricao'=>'Cliente presente na view de carrinho abandonado.','categoria'=>'carrinho','tipo_valor'=>'boolean','expressao_sql'=>'vca.cliente_id','operadores_json'=>['is_true','is_false','exists','not_exists'],'ordem'=>21],
        ];
